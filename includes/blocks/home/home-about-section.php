<?php   
$has_htext=get_field('has_htext');
$has_ptext=get_field('has_ptext');
	...
	<section id="team" class="">
        ...
        <div class="container">            
            <div class="row">
                ...
                <?php //print_r($has_teams);?>
                <?php foreach($has_teams as $key=>$has_team):?>

                <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay="<?php echo $key == 0 ? 'active':'';?>">
