            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInDown animated" data-wow-delay=".5s">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInRight animated" data-wow-delay=".5s">
                     <img src="<?php echo get_template_directory_uri();?>/assets/img/about-img.jpg"/>               
                  </div>     
            </div>
        </div>   
		<!-- =============== container end =============== -->		
        ...
        <div class="container">            
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".1s">
                   <div class="timg"><img src="<?php echo get_template_directory_uri();?>/assets/img/team-img1.jpg"/></div>
				    <div class="t-box">
				   <h3>MOHD SUBHAN</h3>
				  ...
				  <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInUp animated" data-wow-delay=".2s">
                    <div class="timg"><img src="<?php echo get_template_directory_uri();?>/assets/img/team-img2.jpg"/></div>
				   <div class="t-box">
				   <h3>Mohd Rahman</h3>
				  ...
				  <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInDown animated" data-wow-delay=".3s">
                    <div class="timg"><img src="<?php echo get_template_directory_uri();?>/assets/img/team-img3.jpg"/></div>
				   <div class="t-box">
				   <h3>ZEENAT SUBHAN</h3>
				  ...
				  <div class="col-xs-12 col-sm-6 col-md-3 wow fadeInUp animated" data-wow-delay=".4s">
                    <div class="timg"><img src="<?php echo get_template_directory_uri();?>/assets/img/team-img4.jpg"/></div>
				    <div class="t-box">
				   <h3>MOHD SAIF</h3>
        ...
        <div class="container">            
            <div class="row">
			 <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInLeft animated" data-wow-delay=".5s">
                     <img src="<?php echo get_template_directory_uri();?>/assets/img/services-img.jpg" class="img-left"/>               
                  </div>     
                <div class="col-xs-12 col-sm-12 col-md-6 wow fadeInRight animated" data-wow-delay=".5s">
                   <h2>Services</h2>
				   <p>Lorem ipsum dolor sit amet, netus pellentesque mauris, non quis adipiscing aliquam tortor nulla, ut dolor, mauris sem ultricies sed tellus ut aliquam. Donec vel sollicitudin orci mi ut, neque aliquam vel vel nostrum enim tristique, magna rhoncus. Dapibus purus eget cubilia eget, in ut in mi dui ipsum odio, nullam vestibulum aliquam fusce, dignissim venenatis ultricies sed mattis non, metus a libero et. Imperdiet aliquet. Vivamus malesuada, ultrices convallis, diam vitae pellentesque volutpat ante vitae amet, ac leo, arcu duis venenatis in auctor sit suscipit. </p>
...
<!-- =============== Gallery =============== -->
  ...
  <div class="grid baguetteBoxThree gallery">
	  ...
	  <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-1.jpg">	 
	  <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-1.jpg"/>      
		<div class="hover-img"> 
	  ...
	  <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-2.jpg">	 
        <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-2.jpg"/>    
		<div class="hover-img"> 
		<h2>E-commerce</h2>
		<i class="fa fa-camera camera"></i>
		</div>		
	  ...
	  <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-3.jpg">	 
		<img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-3.jpg"/>       
		<div class="hover-img"> 
		<h2>Website Design</h2>
		<i class="fa fa-camera camera"></i>
		</div>		
	 ...
	 <div class="element-item transition ecommerce " data-category="post-transition">
	   <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-4.jpg">	 
	    <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-4.jpg"/>       
		<div class="hover-img"> 
		<h2>E-commerce</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
      ...
      <div class="element-item post-transition logo " data-category="post-transition">
         <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-5.jpg">	 
	    <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-5.jpg"/>       
		<div class="hover-img"> 
		<h2>Logo</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
      ...
      <div class="element-item post-transition cms " data-category="post-transition">
		 <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-6.jpg">	 
	    <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-6.jpg"/>       
		<div class="hover-img"> 
		<h2>CMS</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
	  ...
	  <div class="element-item post-transition logo " data-category="post-transition">
         <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-7.jpg">	 
	    <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-7.jpg"/>       
		<div class="hover-img"> 
		<h2>Logo</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
	  ...
	  <div class="element-item transition cms " data-category="post-transition">
	   <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-8.jpg">	 
	    <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-8.jpg"/>       
		<div class="hover-img"> 
		<h2>CMS</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
      ...
      <div class="element-item post-transition ecommerce " data-category="post-transition">
         <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-9.jpg">	 
	    <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-9.jpg"/>       
		<div class="hover-img"> 
		<h2>E-commerce</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
      ...
      <div class="element-item post-transition webdesign " data-category="post-transition">
		 <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-10.jpg">	 
	    <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-10.jpg"/>       
		<div class="hover-img"> 
		<h2>Web Design</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
	  ...
	  <div class="element-item post-transition logo " data-category="post-transition">
         <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-11.jpg">	 
	    <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-11.jpg"/>       
		<div class="hover-img"> 
		<h2>Logo</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
	  ...
	  <div class="element-item transition cms " data-category="post-transition">
	   <a href="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-12.jpg">	 
	    <img src="<?php echo get_template_directory_uri();?>/assets/img/gallery/emp-12.jpg"/>       
		<div class="hover-img"> 
		<h2>CMS</h2>
		<i class="fa fa-camera camera"></i>
		</div>	
            ...
            <div class="row">
				...
				<p>Meet some of our lovely, passionate, positive people.</p>
                 ...
                 <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInUp animated" data-wow-delay=".1s">
                      <div class="blog-img">
						<img src="<?php echo get_template_directory_uri();?>/assets/img/blog1.JPG"/>
					  </div>
					  <div class="row">
					  ...
					  <a href="<?php echo get_template_directory_uri();?>/blog-single.html">MORE</a>
					  </div>
                  </div>        
				 <div class="col-xs-12 col-sm-4 col-md-4 wow bounceIn animated" data-wow-delay=".4s">
                      <div class="blog-img">
						<img src="<?php echo get_template_directory_uri();?>/assets/img/blog2.JPG"/>
					  </div>
					  <div class="row">
					  <div class="data">30</div>
					  <div class="month">March</div>
				 ...
				 <div class="col-xs-12 col-sm-4 col-md-4 wow fadeInDown animated" data-wow-delay=".3s">
                      <div class="blog-img">
						<img src="<?php echo get_template_directory_uri();?>/assets/img/blog3.JPG"/>
					  </div>
					  <div class="row">
					  <div class="data">30</div>
					  <div class="month">March</div>
